...
Changes from previous version:
  - _get_wallet_score() now calls wallet_scorer.score_wallet() for real scores
  - wallet address passed through to log_trade() so trades.db tracks who we copied
  - all other logic (dynamic sizing, slippage, cooldown) unchanged
"""
